"""
This script uses the top 3 features found for feature sets A (statistical) and 
B (humanActivity), and runs all the models on them. This will enable us to 
compare the power of automatic feature selection methods from commonly employed
feature sets, and see how well these feature sets fare when only 3 of the best
features are chosen from them. 10-fold cross-validation is used to generate
the results.
...
print("The fold-wise results for the top 3 statistical features (A) have been computed")
...
print("The fold-wise results for the top 3 human activity features (features B) have been computed")
...
print("The fold-wise results for the top 3 overall features (features ABtogether) have been computed")
...
print("The fold-wise results for the top 3 biomechanical features (C2) have been computed")


#%% Save all results

# Saving the foldWiseCVresults
with open('results_top3featuresABC_kFoldCV.pickle', 'wb') as f:
    pickle.dump([resultsA, resultsB, resultsABtogether, resultsC], f)
    
#==============================================================================
# # Loading the file
# with open('results_top3featuresABC_kFoldCV.pickle','rb') as f:
...
savetxt('table[02a1]ML_top3_kFold_agg.csv', resultsMatrix, delimiter=',', fmt='%.1f')
...
filename = 'table[02a1]ML_top3_kFold_meanstd.csv'
